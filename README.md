...
| --- | --- | --- | --- |
| [ALN Fold Wavefolder](plugins/aln_fold_wavefolder/README.md) | `AfT1` | Selectable Buchla 259-style and extended 16-fold wavefolders | `aln_fold_wavefolder.o` |
| [ALN Distortion Bank](plugins/aln_distortion_bank/README.md) | `AdB1` | Eight circuit-inspired distortion models | `aln_distortion_bank.o` |
